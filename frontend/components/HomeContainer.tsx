        ...
        <div className="min-h-screen w-full bg-black flex items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center">
                <div className="text-white">
                    ...
                    <p>{t("paragraph-2-1")}
                        <a href="/reports" className="text-cyan-400 underline hover:text-cyan-400">{t("link-1")}</a>{t("paragraph-2-2")}
                        <a href="/report-manual/manual.pdf" className="text-cyan-400 underline hover:text-cyan-400">{t("link-2")}</a>  {t("paragraph-2-3")}
                    </p>
